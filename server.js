...
app.get("/api/movies", async (req, res) => {
  try {
    ...
    const response = await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=${TMDB_API_KEY}&with_original_language=ta&sort_by=vote_average.desc&vote_count.gte=200`);
